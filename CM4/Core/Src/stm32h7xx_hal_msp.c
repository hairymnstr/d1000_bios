...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL3.PLL3N = 65;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOI, GPIO_PIN_11|GPIO_PIN_15);
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_11);

    HAL_GPIO_DeInit(GPIOK, GPIO_PIN_0|GPIO_PIN_2);

    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_7|GPIO_PIN_10|GPIO_PIN_12);

    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_6|GPIO_PIN_10);
